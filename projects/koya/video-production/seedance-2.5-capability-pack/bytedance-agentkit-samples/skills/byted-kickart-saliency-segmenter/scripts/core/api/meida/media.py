...
class MediaService:
    ...
    def __init__(
        self, repository: Optional[MediaRepository] = None, uploader: Optional[RemoteUploader] = None
    ):  # type: ignore
...
class SimpleMediaService:
    ...
    def __init__(
        self, repository: Optional[SimpleMediaRepository] = None, uploader: Optional[RemoteUploader] = None
    ):
