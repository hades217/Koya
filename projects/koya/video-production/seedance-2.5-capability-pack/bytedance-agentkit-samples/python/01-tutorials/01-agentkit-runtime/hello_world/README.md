...
| 组件 | 描述 |
| - | - |
| **Agent 服务** | [agent.py](https://github.com/bytedance/agentkit-samples/blob/main/python/01-tutorials/01-agentkit-runtime/hello_world/agent.py) - 主应用程序，定义 Agent 和记忆组件 |
