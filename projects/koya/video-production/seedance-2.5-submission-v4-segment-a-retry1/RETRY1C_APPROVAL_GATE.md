# Segment A Retry 1C — provider-compatible paid approval gate

Status: `READY_FOR_USER_APPROVAL`

The provider rejected Retry 1B before task creation because a reference video cannot be mixed with both first-frame and last-frame images. No task ID was created and no generation was queued. Retry 1C keeps the passed 0–8 second reference video as the opening and motion authority, and keeps only the continuity-critical locked last frame.

## Exact input manifest

| Order | Provider role | File | Authority | SHA-256 |
| ---: | --- | --- | --- | --- |
| Video 1 | `reference_video` | `segment-a-passed-motion-0-8s.mp4` | Exact opening, passed aerial/facade/resident/entry/foyer motion and first-frame authority. Ends before the failed lift threshold. | `b1067f6d64c81a172f89a2d866682944de1436631571f008744a47b7acb7c181` |
| Image 1 | `last_frame` | `references/06-locked-inside-lift-end-frame-16x9.png` | Exact endpoint: camera and resident fully inside the same cabin, doors closed. | `afb6c0ce213b47765a405e348da551acdf2930ce043fc106959085837a4aeef1` |
...
- Authorized scope if approved: exactly one Retry 1C task; no automatic further retry and no Segment B/C task
...
@视频1是本次开头、首帧、建筑、人物、空间和摄影机运动的最高权威。前约8秒尽量逐帧保持@视频1已经通过质检的Brisbane/Toowong高空俯冲、Koya持续接近、同一名运动女性、中央玻璃入口、紧凑foyer、写实质感、中性白天色温、空间方向与摄影机动量。不要重新设计、替换或静态放大这些内容。@视频1在人物到达电梯前结束；绝不能复制旧版本中“人物进入但摄影机留在电梯外”的错误。

摄影机从@视频1的高空开头沿固定目标轴快速向前下方飞行，河流、CBD、街区和道路产生真实三维视差；同一栋Koya已经存在于目标地块并在接近过程中持续变大，不得消失、替换或突然生成。约3秒到达街面，建筑外观和层数与@视频1保持一致。
...
@图片1是强制末帧，必须精确到达：摄影机已完全位于同一电梯内部，人物也在轿厢内面向已经完全关闭的同一扇门；左右浅木墙和黑色扶手包围摄影机，foyer、走廊和门槛均不可见。这个末帧将作为下一段电梯上行的第一帧。
