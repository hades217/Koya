...
const stops: TourStop[] = [
  { id: 'entry', label: 'Entry hall', eyebrow: 'Arrival', views: [{ label: 'Entry', image: '/tour/entry.png' }, { label: 'Toward kitchen', image: '/tour/entry-turn.png' }], x: 4, y: 13, connections: ['bath', 'hub'], note: 'The entry begins at the western end of the apartment.' },
  ...
  { id: 'bedroom2', label: 'Bedroom 2', eyebrow: 'Private room', views: [{ label: 'Threshold', image: '/tour/bedroom2-threshold.png' }, { label: 'Room view', image: '/tour/bedroom2.png' }], x: 21, y: 68, connections: ['bath', 'mpr'], note: 'Bedroom 2 opens from the western circulation edge.' },
  { id: 'mpr', label: 'Multipurpose room', eyebrow: 'Flexible space', views: [{ label: 'From dining', image: '/tour/mpr-threshold.png' }, { label: 'Room view', image: '/tour/mpr.png' }], x: 35, y: 67, connections: ['bedroom2', 'hub'], note: 'The compact MPR connects to the dining-side circulation.' },
  { id: 'hub', label: 'Kitchen & dining', eyebrow: 'Living hub', views: [{ label: 'West · MPR', image: '/tour/hub-west.png' }, { label: 'North · Kitchen', image: '/tour/kitchen.png' }, { label: 'East · Living', image: '/tour/living.png' }], x: 56, y: 55, connections: ['entry', 'mpr', 'living', 'bedroom1'], note: 'One island anchors the open-plan kitchen and dining zone.' },
  { id: 'living', label: 'Living room', eyebrow: 'Public space', views: [{ label: 'Enhanced 360° panorama', image: '/tour/local-clarity/living-panorama-realesrgan-8k.webp', panorama360: true }, { label: 'Original 360° comparison', image: '/tour/living-panorama-ai-360-v3-edsr-7k.webp', panorama360: true, midResImage: '/tour/living-panorama-ai-360-v3-sharp-10k.webp', highResImage: '/tour/living-panorama-ai-360-v3-desktop-12k.webp' }, { label: 'AI stitched wide', image: '/tour/living-panorama-ai-v1.png' }, { label: 'Original living', image: '/tour/living.png' }, { label: 'Terrace threshold', image: '/tour/terrace-threshold.png' }], x: 73, y: 68, connections: ['hub', 'terrace', 'bedroom1'], note: 'The living room faces the internal display wall and wraparound glazing. The enhanced panorama is a deterministic super-resolution concept composite, not a measured 360° survey.' },
  { id: 'bedroom1', label: 'Bedroom 1', eyebrow: 'Primary suite', views: [{ label: 'Threshold', image: '/tour/bedroom1-threshold.png' }, { label: 'Bedroom', image: '/tour/bedroom1.png' }, { label: 'Walk-in robe', image: '/tour/wir.png' }], x: 70, y: 30, connections: ['hub', 'ensuite', 'living'], note: 'The primary bedroom connects to the WIR and ensuite.' },
  ...
  { id: 'terrace', label: 'Private terrace', eyebrow: 'Outdoor room', views: [{ label: 'Threshold', image: '/tour/terrace-threshold.png' }, { label: 'Terrace', image: '/tour/terrace.png' }], x: 87, y: 68, connections: ['living'], note: 'The private terrace wraps the living and dining edges.' },
];
