...
const stops: TourStop[] = [
  { id: 'entry', label: 'Entry hall', eyebrow: 'Arrival', views: [{ label: 'Enhanced 360° panorama', image: '/tour/panoramas/entry-panorama-4k.webp', midResImage: '/tour/panoramas/entry-panorama-8k.webp', panorama360: true }, { label: 'Entry', image: '/tour/entry.png' }, { label: 'Toward kitchen', image: '/tour/entry-turn.png' }], x: 4, y: 13, connections: ['bath', 'hub'], note: 'The entry begins at the western end of the apartment. The panorama is a floor-plan-grounded AI concept, not a measured 360° survey.' },
