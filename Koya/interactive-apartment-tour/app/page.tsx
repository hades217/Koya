...
const stops: TourStop[] = [
  { id: 'entry', label: 'Entry hall', eyebrow: 'Arrival', views: [{ label: 'Corrected 360° panorama', image: '/tour/panoramas/entry-panorama-v2-4k.webp', midResImage: '/tour/panoramas/entry-panorama-v2-8k.webp', panorama360: true }, { label: 'Entry', image: '/tour/entry.png' }, { label: 'Toward kitchen', image: '/tour/entry-turn.png' }], x: 4, y: 13, connections: ['bath', 'hub'], note: 'The view starts immediately inside the Apartment 106 front door. Storage, Laundry and Bath remain on the viewer-left side of the inward hall; the viewer-right wall remains solid. This is a floor-plan-grounded AI concept, not a measured 360° survey.' },
