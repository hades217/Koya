...
| 组件 | 描述 |
| - | - |
| **Agent 服务** | [agent.py](https://github.com/bytedance/agentkit-samples/blob/main/python/workshop/beginner/travel_concierge/agent.py) - 旅游规划 Agent 应用 |
| **专业指令** | [agent.py](https://github.com/bytedance/agentkit-samples/blob/main/python/workshop/beginner/travel_concierge/agent.py#L21-L94) - 详细的角色定义和工作流程 |
| **测试客户端** | [client.py](https://github.com/bytedance/agentkit-samples/blob/main/python/workshop/beginner/travel_concierge/client.py) - SSE 流式调用客户端 |
| **项目配置** | [pyproject.toml](https://github.com/bytedance/agentkit-samples/blob/main/python/workshop/beginner/travel_concierge/pyproject.toml) - 依赖管理（uv 工具） |
| **Web 搜索** | `web_search` - 内置的网络搜索工具 |
| **短期记忆** | 本地后端存储会话上下文 |

### 代码特点

**Agent 定义**（[agent.py](https://github.com/bytedance/agentkit-samples/blob/main/python/workshop/beginner/travel_concierge/agent.py#L100-L105)）：
...
**专业指令系统**（[agent.py](https://github.com/bytedance/agentkit-samples/blob/main/python/workshop/beginner/travel_concierge/agent.py#L21-L44)）：
...
**工具集成**（[agent.py](https://github.com/bytedance/agentkit-samples/blob/main/python/workshop/beginner/travel_concierge/agent.py#L104)）：
...
1. **[Hello World](https://github.com/bytedance/agentkit-samples/blob/main/python/01-tutorials/01-agentkit-runtime/hello_world/README.md)** - 了解基础 Agent
2. **[MCP Simple](https://github.com/bytedance/agentkit-samples/blob/main/python/01-tutorials/01-agentkit-runtime/mcp_simple/README.md)** - 集成更多专业工具
3. **[Multi Agents](https://github.com/bytedance/agentkit-samples/blob/main/python/01-tutorials/01-agentkit-runtime/multi_agents/README.md)** - 构建多Agent协作
