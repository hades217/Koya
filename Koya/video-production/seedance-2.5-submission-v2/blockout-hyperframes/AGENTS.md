...
## Koya Seedance rules — mandatory

Before using this blockout for Seedance planning or generation, read and follow `../../SEEDANCE_2_5_RULES.md`. In particular, a continuous architectural shot must become a deterministic reference video; still storyboard panels are QA references, not guaranteed ordered Seedance keyframes. No paid task may be submitted without the rulebook's manifest and approval gate.
